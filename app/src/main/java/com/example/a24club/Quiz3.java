...
import static com.example.a24club.QuestionAnswer3.correctAnswers;
...
public class Quiz3 extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        ...
        if(clickedButton.getId()==R.id.submit_btn){
            ...
            if(selectedAnswer.equals(QuestionAnswer3.choices[currentQuestionIndex][0])){
                ansA.setBackgroundColor(Color.RED);
            }

            if(selectedAnswer.equals(QuestionAnswer3.choices[currentQuestionIndex][1])){
                ansB.setBackgroundColor(Color.RED);
            }

            if(selectedAnswer.equals(QuestionAnswer3.choices[currentQuestionIndex][2])){
                ansC.setBackgroundColor(Color.RED);
            }

            if(selectedAnswer.equals(QuestionAnswer3.choices[currentQuestionIndex][3])){
                ansD.setBackgroundColor(Color.RED);
            }


            //GoGreen Logic Here
            if(QuestionAnswer3.choices[currentQuestionIndex][0].equals(correctAnswers[currentQuestionIndex])){
                ansA.setBackgroundColor(Color.GREEN);
            }

            if(QuestionAnswer3.choices[currentQuestionIndex][1].equals(correctAnswers[currentQuestionIndex])){
                ansB.setBackgroundColor(Color.GREEN);
            }

            if(QuestionAnswer3.choices[currentQuestionIndex][2].equals(correctAnswers[currentQuestionIndex])){
                ansC.setBackgroundColor(Color.GREEN);
            }

            if(QuestionAnswer3.choices[currentQuestionIndex][3].equals(correctAnswers[currentQuestionIndex])){
    ...
    void finishQuiz(){
        int potentialNewHighScore = score * 100 / QuestionAnswer3.question.length;
    ...
    void practiceAgain() {
        ...
        Intent intent = new Intent(Quiz3.this, Categories.class);

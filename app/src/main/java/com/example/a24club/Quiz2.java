...
import static com.example.a24club.QuestionAnswer2.correctAnswers;
...
public class Quiz2 extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        ...
        if(clickedButton.getId()==R.id.submit_btn){
            ...
            if(selectedAnswer.equals(QuestionAnswer2.choices[currentQuestionIndex][0])){
                ansA.setBackgroundColor(Color.RED);
            }

            if(selectedAnswer.equals(QuestionAnswer2.choices[currentQuestionIndex][1])){
                ansB.setBackgroundColor(Color.RED);
            }

            if(selectedAnswer.equals(QuestionAnswer2.choices[currentQuestionIndex][2])){
                ansC.setBackgroundColor(Color.RED);
            }

            if(selectedAnswer.equals(QuestionAnswer2.choices[currentQuestionIndex][3])){
                ansD.setBackgroundColor(Color.RED);
            }


            //GoGreen Logic Here
            if(QuestionAnswer2.choices[currentQuestionIndex][0].equals(correctAnswers[currentQuestionIndex])){
                ansA.setBackgroundColor(Color.GREEN);
            }

            if(QuestionAnswer2.choices[currentQuestionIndex][1].equals(correctAnswers[currentQuestionIndex])){
                ansB.setBackgroundColor(Color.GREEN);
            }

            if(QuestionAnswer2.choices[currentQuestionIndex][2].equals(correctAnswers[currentQuestionIndex])){
                ansC.setBackgroundColor(Color.GREEN);
            }

            if(QuestionAnswer2.choices[currentQuestionIndex][3].equals(correctAnswers[currentQuestionIndex])){
    ...
    void finishQuiz(){
        int potentialNewHighScore = score * 100 / QuestionAnswer2.question.length;
    ...
    void practiceAgain() {
        ...
        Intent intent = new Intent(Quiz2.this, Categories.class);
